...
public enum Information {
    INFO_ABOUT_SHELTER("Занимаемся отловом, лечением, стерилизацией и содержанием бездомных животных ",
            "/info_about_shelter"),
    ...
    SHELTER_SAFETY_PRECAUTIONS(" Итак, что мы просим наших гостей: 1️⃣ Передвигаться по территории приюта с волонтером " +
            "Мы понимаем ваш интерес и желание посмотреть на всех хвостатых, но это можно сделать только в присутствии волонтера " +
            "2️⃣ Не подходить слишком близко и не совать руки в вольеры С уверенностью можно сказать, что большинство питомцев в вольерах вас встретят с виляющим хвостом " +
